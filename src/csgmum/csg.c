...
inline void SWAP_EDGE(CSG *csg, CSG_Node *source, CSG_Node *old, CSG_Node *nnew)
{
	int nout = OUT(source);
...
inline void INS_EDGE(CSG *csg, CSG_Node *source, CSG_Node *target)
{ 
	CSG_Node **bucket;
...
inline int class_link(CSG *csg, CSG_Node **state, CSG_Node **parent, int *lprefix)
{
...
inline CSG_Node *insert_leaf(CSG *csg, const char *pendent, int split_lprefix)
{
...
inline CSG_Node *to_clone(CSG *csg, CSG_Node *state, CSG_Node *nextState)
...
inline CSG_Node *divide(CSG *csg, CSG_Node *state, int lprefix, CSG_Node *target)
{
...
inline CSG_Node *compres_leaf(CSG *csg, CSG_Node *source, CSG_Node *parent_state
...
inline CSG_Node *arrange_link(CSG *csg, CSG_Node *state, CSG_Node *waiting, int go_sl)
{
	int lprefix      = LEN_L(state);
	int is_end       = TRUE;
...
inline CSG_Node *add_suffixes(CSG *csg, CSG_Node *state, CSG_Node *waiting
, const char **pendent)
{
...
inline CSG_Node *divide_and_compress(CSG *csg, CSG_Node *state, CSG_Node *cloned
, int lprefix)
{ 
