...
inline void Merge_Pair(UM *Pair, UM *PairRC, int size, int length, SP *SPF, SP *SPR, int pos);
inline void Merge_Master( UM *Master, UM *MasterRC, int size, int length, SP *SPF, SP *SPR, ulong * MSP, int pos);
